Feature: cucmber expressions

  Scenario: I am to use integers
  ...
  # Scenario: I am able to captuer and use words
  ...
  Scenario: I am able to capture words and numbers using regular expressions
    ...
    Given I provide an email address jmclaughlin@spartaglobal.co.uk
