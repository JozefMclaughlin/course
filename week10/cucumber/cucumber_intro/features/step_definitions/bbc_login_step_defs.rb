...
Then("I will see an error for blank details") do
  expect(bbc_sign_in_page.find_username_err_msg).to eq bbc_sign_in_page.blank_error
  expect(bbc_sign_in_page.find_password_err_msg).to eq bbc_sign_in_page.blank_error
end
